          ...
          <div className="detail__gift">
            <div className="gift-box">
              <div className="ribbon">
                <span className="rib">Ưu dãi chỉ có tại Đức Việt</span>
              </div>
              <ul className="main-gift">
                <li>
                  <span className="bold_red">Tặng</span> thêm vợt muỗi{" "}
                  <span className="bold_red">YAGE YG-D003</span> áp dụng tất cả
                  đơn hàng tủ lạnh trên 10 triệu.
                </li>
                <li>
                  <b>Giá khuyến mãi</b> áp dụng từ{" "}
                  <span className="bold_red">23/10/2023</span> đến hết{" "}
                  <span className="bold_red">31/10/2030.</span>
                </li>
                <li>
                  Giao <b>siêu tốc trong ngày</b> cho đơn hàng từ 3 triệu trong
                  phạm vi 10km.
                </li>
              </ul>
            </div>
