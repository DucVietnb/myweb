...
class ProductPrime extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: [],
      ...
      <>
        <div className="product-page__container">
          <div className="main-product">
            <div className="title">Sản phẩm cao cấp</div>
                      ...
                      >
                        ...
                        <div className="product__info">
                          ...
                          <span className="price--real">
                            {this.formatCash(item.truePrice.toString())}₫
                          </span>
...
const mapStateToProps = (state) => {
  return {
    ...
    products: state.product.products_prime,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    productPrimeStart: () => dispatch(actions.productPrimeStart()),
  };
};

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ProductPrime)
);
