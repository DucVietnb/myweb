...
class ProductLg extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: [],
  ...
  componentDidMount() {
    this.props.getProductByBrandStart("Lg");
  }
      ...
      <>
        <div className="product-page__container">
          <div className="main-product">
            <div className="title">Sản phẩm hãng LG</div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ProductLg)
);
