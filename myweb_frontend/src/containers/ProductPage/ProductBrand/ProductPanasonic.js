...
class ProductPanasonic extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: [],
  ...
  componentDidMount() {
    this.props.getProductByBrandStart("Panasonic");
  }
      ...
      <>
        <div className="product-page__container">
          <div className="main-product">
            <div className="title">Sản phẩm hãng Panasonic</div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ProductPanasonic)
);
